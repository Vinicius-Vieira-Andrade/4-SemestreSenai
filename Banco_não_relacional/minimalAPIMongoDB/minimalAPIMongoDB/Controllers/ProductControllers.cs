...
namespace minimalAPIMongoDB.Controllers
{
    ...
    public class ProductControllers : ControllerBase
    {
        ...
        public async Task<ActionResult<List<Product>>> Get()
        {
            try
            {
                //aqui ele busca todos os produtos, o "filterDefinition<Tdocument>.Empty" o EMPTY simboliza tudo
...
//Criar a classe User na pata domains
//Id, name, email, password e atributos
